...
Creating a mapping is standard PowerDesigner functionality, where you can add a mapping on an entity. You can add a mapping by going to the 'Mapping' tab on an entity and click on the 'Add a mapping' icon on the right of the mapping list drop-down.
...
To add attribute mapping, in the mapping tab of an entity, go the the 'Attribute mappings' tab.
